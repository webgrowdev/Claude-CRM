  ...
  return (
    <>
      ...
      <PageContainer>
            ...
            {calendarDays.map((day, index) => {
              ...
              return (
                <button
                  ...
                  className={`relative h-12 flex flex-col items-center justify-center transition-colors ${
        ...
        <div className="mt-6">
          <h3 className="text-base font-semibold text-slate-800 mb-3 capitalize">
            {isToday(selectedDate)
              ? 'Hoy'
