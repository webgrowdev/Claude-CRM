...
export const translations = {
  es: {
    ...
    // Activity Statuses (per activity/treatment)
    activityStatus: {
      new: 'Nuevo',
      contacted: 'Contactado',
      scheduled: 'Agendado',
    ...
    // Workflow
    workflow: {
      title: 'Progreso del Lead',
      nextStep: '¿Siguiente paso?',
      newLeadTitle: 'Lead Nuevo',
      newLeadDesc: 'Lead recibido',
      contactedTitle: 'Contactado',
      contactedDesc: 'Primer contacto establecido',
      scheduledTitle: 'Agendado',
      scheduledDesc: 'Cita agendada',
      completedTitle: 'Completado',
      completedDesc: 'Servicio completado',
      droppedTitle: 'Actividad Abandonada',
      droppedDesc: 'Sin avance reciente',
      lostTitle: 'Lead Perdido',
      lostDesc: 'No interesado',
      contactLeadCTA: 'Contactar Lead',
      contactLeadDesc: 'Contacta a este lead para iniciar la conversación.',
      scheduleAppointmentCTA: 'Agendar Cita',
      scheduleAppointmentDesc: 'Agenda una cita o seguimiento con el paciente.',
      markCompletedCTA: 'Marcar como Completado',
      markCompletedDesc: 'Confirma cuando el paciente haya asistido a la cita.',
      appointmentScheduled: 'Cita agendada',
      activityCompleted: '¡Completado!',
      activityCompletedDesc: 'Esta actividad ha sido completada exitosamente.',
      newActivity: 'Nueva Actividad',
      noActivitiesTitle: 'Sin actividades',
      noActivitiesDesc: 'Este lead aún no tiene actividades. Contacta al paciente para crear la primera actividad.',
      noFollowUpsTitle: 'Sin seguimientos agendados',
      noFollowUpsDesc: 'El lead fue contactado pero aún no tiene seguimientos agendados. Programa una cita o llamada.',
      contactNow: 'Contactar ahora',
      scheduleFollowUp: 'Agendar seguimiento',
    },
    ...
    patients: {
      ...
      via: 'Vía',
      activity: 'Actividad',
      activitySubtitle: 'Historial completo del paciente',
  ...
  en: {
    ...
    workflow: {
      ...
      newLeadDesc: 'Lead received',
      contactedTitle: 'Contact Made',
      contactedDesc: 'First contact established',
      scheduledTitle: 'Scheduled',
      scheduledDesc: 'Appointment scheduled',
      completedTitle: 'Completed',
      completedDesc: 'Service completed',
      droppedTitle: 'Activity Dropped',
      droppedDesc: 'No recent progress',
      lostTitle: 'Lead Lost',
      lostDesc: 'Not interested',
      contactLeadCTA: 'Contact Lead',
      contactLeadDesc: 'Contact this lead to start the conversation.',
      scheduleAppointmentCTA: 'Schedule Appointment',
      scheduleAppointmentDesc: 'Schedule an appointment or follow-up with the patient.',
      markCompletedCTA: 'Mark as Completed',
      markCompletedDesc: 'Confirm once the patient has attended the appointment.',
      appointmentScheduled: 'Appointment scheduled',
      activityCompleted: 'Completed!',
      activityCompletedDesc: 'This activity has been completed successfully.',
      newActivity: 'New Activity',
      noActivitiesTitle: 'No activities',
      noActivitiesDesc: 'This lead has no activities yet. Contact the patient to create the first activity.',
      noFollowUpsTitle: 'No follow-ups scheduled',
      noFollowUpsDesc: 'The lead was contacted but has no follow-ups scheduled. Schedule an appointment or call.',
    ...
    patients: {
      ...
      via: 'Via',
      activity: 'Activity',
      activitySubtitle: 'Complete patient history',
      addNote: 'Add note',
